...
This is an extension of the [YOLOv2-Framework](https://github.com/molecular-nanophotonics/YOLOv2-Framework/) to enable the detection the oriented bounding boxes. 
